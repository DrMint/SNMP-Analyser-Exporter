# Taken from https://github.com/alessandromaggio/quicksnmp
# Quick SNMP (quicksnmp) by alessandromaggio
...
def getSimplified(ip, oid, community):
        return get(ip, [oid], hlapi.CommunityData(community)).get(oid)
